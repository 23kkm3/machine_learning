...
def mean_negative_loglikelihood(Y, pYhat):
    ...
    """
    # Binary vector Y times log of predicted probabilities of Y hat 
...
class LogisticRegression:
    ...
    def _calculate_gradient(self, Xmat, Y, theta_p, h=1e-5):
        ...
        for x in range(0, d):
            ...
            # implementation of L2 regularization; adding lambda value to loss function
            if self.lamda != None:
            ...
            # gradient caclulation using mean negative log likelihood as loss function
    ...
    def fit(self, Xmat, Y, max_iterations=1000, tolerance=1e-6, verbose=False):
        ...
        while iteration < max_iterations and np.mean(np.abs(theta_new-theta)) >= tolerance:
            ...
            # The following lines were all included from my submission of HW1
    ...
    def predict(self, Xmat):
        ...
        # We have already obtained our optimal theta b/c log. regr. has executed at this point
